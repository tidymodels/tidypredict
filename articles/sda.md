...
- Create the R formulas, one per class
  ...
  fit[["setosa"]]
  #> exp(-13.1507094677662 + (Sepal.Length * 5.73266109594555) + (Sepal.Width * 
  #>     11.3604293693887) + (Petal.Length * -16.8084846238169) + 
  #>     (Petal.Width * -16.6240117338793))/(exp(-13.1507094677662 + 
...
#>     (Petal.Width * 14.1269553854406))/(exp(-13.1507094677662 + 
#>     (Sepal.Length * 5.73266109594555) + (Sepal.Width * 11.3604293693887) + 
#>     (Petal.Length * -16.8084846238169) + (Petal.Width * -16.6240117338793)) + 
#>     exp(-2.17403913501331 + (Sepal.Length * -1.38327577793292) + 
#>         (Sepal.Width * -4.20634050168113) + (Petal.Length * 4.57106120700436) + 
...
#> exp(-9.69338951858337 + (mpg * -0.300898442298614) + (ifelse(gear == 
#>     "4", 1, 0) * -0.288744001063268) + (ifelse(gear == "5", 1, 
#>     0) * 0.346792280462245) + (disp * 0.0491641125277205))/(exp(-5.90478040863942 + 
#>     (mpg * 0.450539182424721) + (ifelse(gear == "4", 1, 0) * 
#>     0.12033481185876) + (ifelse(gear == "5", 1, 0) * -0.326397688436069) + 
#>     (disp * -0.0361970033802602)) + exp(4.82341069251291 + (mpg * 
#>     -0.145463097730621) + (ifelse(gear == "4", 1, 0) * 0.189561232611208) + 
#>     (ifelse(gear == "5", 1, 0) * -0.0358060646840255) + (disp * 
#>     -0.0157055813201664)) + exp(-9.69338951858337 + (mpg * -0.300898442298614) + 
#>     (ifelse(gear == "4", 1, 0) * -0.288744001063268) + (ifelse(gear == 
