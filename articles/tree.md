...
This article documents the version 2 parsed model spec for tree models.
Version 3 is the current format, and tidypredict still reads version 2
models for backwards compatibility. See [tree
