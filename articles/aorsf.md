...
#>         wt + 0.84109533190524 * drat + -0.86426993142018 * carb <= 
#>         -6.36065505089175 ~ case_when(-0.279347919999303 * vs + 
#>         -2.43472422259486 * cyl + -1.53141538025346 * drat + 
#>         1.96682379319858 * am <= -20.890841546162 ~ case_when(0.940955334080965 * 
#>         cyl + 0.0956253841837064 * qsec + -0.0238807926628254 * 
#>         disp <= 0.642952410929747 ~ 14.5375, .default = 16.56), 
#>         .default = 21.9125), .default = case_when(-0.144022263042667 * 
#>         disp <= -11.3777587803707 ~ 25.86, .default = 31.0666666666667)) + 
#>         case_when(0.530381783199017 * gear + 2.25752944144112 * 
#>             vs + -0.198247392529822 * qsec + -0.0341743962751912 * 
#>             disp <= -4.97256371024265 ~ case_when(-1.06421141630588 * 
...
#>                 carb + 2.16307897004316 * vs <= -12.1057221813812 ~ 
#>                 11.26, .default = case_when(-2.21136767317935 * 
#>                 drat + 1.97393024382369 * vs <= -6.96580817051496 ~ 
#>                 14.6571428571429, .default = 16.68)), .default = 20.85), 
#>             .default = 26.2888888888889) + case_when(-0.0132590726063641 * 
#>         disp + -3.09360679297839 * wt + 1.24739815160256 * am + 
#>         -0.844277980493477 * carb <= -16.2413398586462 ~ case_when(0.422670549391509 * 
#>         drat + -3.29311245511077 * wt <= -12.1053691056689 ~ 
#>         12.8, .default = 16.34), .default = case_when(-5.13581158714948 * 
#>         wt + -1.43747181787514 * carb + 0.105053420827927 * cyl + 
#>         2.09924563666986 * gear <= -2.94913856558917 ~ case_when(3.22585061994598 * 
...
#>             vs + 9.78371125911463 * drat + 0.0383272700135065 * 
#>             hp <= 45.9662492476846 ~ 21.76, .default = case_when(-0.0558201660441368 * 
...
#> ifelse(is.na(cyl) | is.na(disp) | is.na(hp) | is.na(drat) | is.na(wt) | 
#>     is.na(qsec) | is.na(vs) | is.na(am) | is.na(gear) | is.na(carb), 
#>     NA_real_, (case_when(0.0196071721873916 * hp + -3.9720550232519 * 
#>         carb + 8.60426828110149 * gear + -0.683831515555862 * 
#>         vs <= 23.3137072451098 ~ case_when(0.0190460629187708 * 
#>         disp + 0.806270082268856 * qsec + -4.94112323945076 * 
#>         wt + 1.96679304378293 * drat <= 7.69401929401893 ~ case_when(-0.376468986860399 * 
#>         qsec + 0.164137189391162 * drat <= -6.04665919994007 ~ 
#>         13.94, .default = 15.04), .default = case_when(0.011343142310457 * 
