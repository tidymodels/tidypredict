...
#>     NA_real_, (case_when(3.60801211635648 * vs + -3.66260984300838 * 
#>         wt + 0.841095331905242 * drat + -0.86426993142018 * carb <= 
#>         -6.36065505089174 ~ case_when(-0.279347919999324 * vs + 
#>         -2.43472422259486 * cyl + -1.53141538025345 * drat + 
#>         1.96682379319857 * am <= -20.890841546162 ~ case_when(0.940955334080976 * 
#>         cyl + 0.095625384183708 * qsec + -0.0238807926628254 * 
#>         disp <= 0.642952410929853 ~ 14.5375, .default = 16.56), 
#>         .default = 21.9125), .default = case_when(-0.144022263042666 * 
#>         disp <= -11.3777587803706 ~ 25.86, .default = 31.0666666666667)) + 
#>         case_when(0.530381783199018 * gear + 2.25752944144111 * 
#>             vs + -0.198247392529819 * qsec + -0.0341743962751913 * 
#>             disp <= -4.97256371024261 ~ case_when(-1.06421141630588 * 
#>             qsec + 3.40854802689151 * drat + -1.2228056108415 * 
#>             carb + -2.50373320531426 * cyl <= -28.3559671262114 ~ 
#>             case_when(-2.16919281134838 * wt + -0.179364980450563 * 
#>                 carb + 2.16307897004315 * vs <= -12.1057221813812 ~ 
#>                 11.26, .default = case_when(-2.21136767317937 * 
#>                 drat + 1.97393024382369 * vs <= -6.96580817051501 ~ 
#>                 14.6571428571429, .default = 16.68)), .default = 20.85), 
#>             .default = 26.2888888888889) + case_when(-0.0132590726063641 * 
#>         disp + -3.09360679297838 * wt + 1.24739815160257 * am + 
#>         -0.844277980493478 * carb <= -16.2413398586462 ~ case_when(0.422670549391512 * 
#>         drat + -3.29311245511077 * wt <= -12.1053691056689 ~ 
#>         12.8, .default = 16.34), .default = case_when(-5.13581158714949 * 
#>         wt + -1.43747181787514 * carb + 0.10505342082793 * cyl + 
#>         2.09924563666986 * gear <= -2.94913856558915 ~ case_when(3.22585061994598 * 
...
#>             vs + 9.78371125911463 * drat + 0.0383272700135064 * 
#>             hp <= 45.9662492476846 ~ 21.76, .default = case_when(-0.0558201660441367 * 
...
#> ifelse(is.na(cyl) | is.na(disp) | is.na(hp) | is.na(drat) | is.na(wt) | 
#>     is.na(qsec) | is.na(vs) | is.na(am) | is.na(gear) | is.na(carb), 
#>     NA_real_, (case_when(0.0196071721873915 * hp + -3.9720550232519 * 
#>         carb + 8.60426828110148 * gear + -0.683831515555862 * 
#>         vs <= 23.3137072451098 ~ case_when(0.0190460629187707 * 
#>         disp + 0.806270082268855 * qsec + -4.94112323945075 * 
#>         wt + 1.96679304378293 * drat <= 7.69401929401893 ~ case_when(-0.376468986860396 * 
#>         qsec + 0.164137189391176 * drat <= -6.04665919993998 ~ 
#>         13.94, .default = 15.04), .default = case_when(0.0113431423104573 * 
...
#>             carb + 0.01757973613961 * hp + 0.151557657147848 * 
#>             vs <= -7.53542603238095 ~ case_when(-0.640463950860864 * 
#>             qsec + -1.50665730147199 * vs + -2.74849156377637 * 
#>             cyl + -0.933782800030739 * carb <= -34.9355244601654 ~ 
#>             case_when(-0.336660555121157 * qsec + -0.0303401830236198 * 
#>                 disp <= -14.4277124700952 ~ 14.525, .default = 16.4666666666667), 
#>             .default = case_when(-2.13085106382978 * carb + -0.548936170212755 * 
#>                 vs + 5.02765957446806 * gear <= 10.8212765957446 ~ 
#>                 18.26, .default = 19.8333333333333)), .default = 28.3571428571429) + 
#>         case_when(-0.917968908101506 * cyl + 3.83865193910176 * 
#>             am + 4.86326569484682 * vs + -1.75411199395579 * 
#>             wt <= -3.13249600266023 ~ case_when(-0.0528304923638516 * 
#>             hp + 3.18409575242937 * am + -0.110332704050222 * 
#>             qsec + -0.735815417254628 * carb <= -12.5948296211181 ~ 
#>             case_when(-0.0302740348005678 * disp + -0.0174008021446288 * 
#>                 hp <= -17.3227598055144 ~ 12.12, .default = 16.1666666666667), 
#>             .default = case_when(-1.94299739846774 * cyl + -0.868715704327313 * 
#>                 drat + -0.662597346776914 * wt <= -16.6381298910434 ~ 
#>                 19.325, .default = 23.15)), .default = 31.5285714285714) + 
