...
- Create the R formulas, one per class
  ...
  #>     (Sepal.Width * 15.9607000492876) + (Petal.Length * 3.26878502392694) + 
  ...
  #>         (Sepal.Width * -7.61595839316377) + (Petal.Length * 33.559537097271) + 
  ...
  #>         Petal.Width * 4.77612732803425) + (Sepal.Width * Sepal.Width * 
  ...
  #>         17.9350353034304) + (Petal.Width * Petal.Width * -53.0229530714453))) + 
  #>     exp(-67.7090772023947 + (Sepal.Length * 7.37247478397155) + 
  #>         (Sepal.Width * 13.2452613006359) + (Petal.Length * 6.23406948373776) + 
  #>         (Petal.Width * 9.66197608445423) + (Sepal.Length * Sepal.Length * 
  ...
  #>         (-113.714590795937 + (Sepal.Length * 44.5528812152965) + 
  #>             (Sepal.Width * -7.61595839316377) + (Petal.Length * 
  ...
  #>             (Sepal.Length * Petal.Width * 4.77612732803425) + 
  ...
  #>             Petal.Width * 17.9350353034304) + (Petal.Width * 
...
#>     Petal.Length * -19.3881020632003) + (Petal.Length * Petal.Width * 
#>     17.9350353034304) + (Petal.Width * Petal.Width * -53.0229530714453) - 
#>     (-67.7090772023947 + (Sepal.Length * 7.37247478397155) + 
#>         (Sepal.Width * 13.2452613006359) + (Petal.Length * 6.23406948373776) + 
#>         (Petal.Width * 9.66197608445423) + (Sepal.Length * Sepal.Length * 
#>         -5.26693339970326) + (Sepal.Length * Sepal.Width * 3.47972623582807) + 
#>         (Sepal.Length * Petal.Length * 9.96014594453995) + (Sepal.Length * 
...
#>             6.23406948373776) + (Petal.Width * 9.66197608445423) + 
