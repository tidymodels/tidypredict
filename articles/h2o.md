...
#>     1.26925770017156, .default = 0) + case_when(disp < 101.545547485352 ~ 
#>     0.0549192265978302, .default = 0) + case_when(disp < 97.7222671508789 & 
#>     hp < 118 ~ 0.0549192265954108, .default = 0) + -0.0243188365426765 * 
#>     hp + -0.00296051728171432 * disp)
```
