...
#>     1.26925770017158, .default = 0) + case_when(disp < 101.545547485352 ~ 
#>     0.0549192265980594, .default = 0) + case_when(disp < 97.7222671508789 & 
#>     hp < 118 ~ 0.0549192265952101, .default = 0) + -0.0243188365426763 * 
#>     hp + -0.00296051728171436 * disp)
```
