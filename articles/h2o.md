...
#> 33.6849250683784 + (-2.98365666456687 * wt + case_when(wt < 2.25968027114868 ~ 
#>     1.26925770017166, .default = 0) + case_when(disp < 101.545547485352 ~ 
#>     0.0549192265979581, .default = 0) + case_when(disp < 97.7222671508789 & 
#>     hp < 118 ~ 0.0549192265953309, .default = 0) + -0.0243188365426768 * 
#>     hp + -0.00296051728171429 * disp)
```
