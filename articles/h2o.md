...
#>     1.26925770017169, .default = 0) + case_when(disp < 101.545547485352 ~ 
#>     0.0549192265974003, .default = 0) + case_when(disp < 97.7222671508789 & 
#>     hp < 118 ~ 0.054919226595942, .default = 0) + -0.024318836542677 * 
#>     hp + -0.00296051728171513 * disp)
```
