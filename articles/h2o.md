...
#>     1.26925770017167, .default = 0) + case_when(disp < 101.545547485352 ~ 
#>     0.0549192265978551, .default = 0) + case_when(disp < 97.7222671508789 & 
#>     hp < 118 ~ 0.0549192265954517, .default = 0) + -0.0243188365426764 * 
#>     hp + -0.00296051728171453 * disp)
```
