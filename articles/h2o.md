...
#>     1.26925770017174, .default = 0) + case_when(disp < 101.545547485352 ~ 
#>     0.0549192265975549, .default = 0) + case_when(disp < 97.7222671508789 & 
#>     hp < 118 ~ 0.0549192265957341, .default = 0) + -0.0243188365426763 * 
#>     hp + -0.0029605172817143 * disp)
```
