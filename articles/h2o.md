...
#> 33.6849250683785 + (-2.98365666456686 * wt + case_when(wt < 2.25968027114868 ~ 
#>     1.26925770017155, .default = 0) + case_when(disp < 101.545547485352 ~ 
#>     0.0549192265976988, .default = 0) + case_when(disp < 97.7222671508789 & 
#>     hp < 118 ~ 0.0549192265956417, .default = 0) + -0.0243188365426769 * 
#>     hp + -0.00296051728171461 * disp)
```
