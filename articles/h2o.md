...
#> 33.6849250683785 + (-2.98365666456683 * wt + case_when(wt < 2.25968027114868 ~ 
#>     1.2692577001716, .default = 0) + case_when(disp < 101.545547485352 ~ 
#>     0.0549192265974732, .default = 0) + case_when(disp < 97.7222671508789 & 
#>     hp < 118 ~ 0.0549192265957466, .default = 0) + -0.0243188365426764 * 
#>     hp + -0.00296051728171437 * disp)
```
