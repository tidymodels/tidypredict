...
#>     1.26925770017175, .default = 0) + case_when(disp < 101.545547485352 ~ 
#>     0.054919226597816, .default = 0) + case_when(disp < 97.7222671508789 & 
#>     hp < 118 ~ 0.0549192265954268, .default = 0) + -0.0243188365426766 * 
#>     hp + -0.00296051728171398 * disp)
```
