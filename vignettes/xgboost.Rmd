...
Please be aware that xgboost converts data into 32-bit floats internally. This could possibly lead to splits being done incorrectly. Always verify that the predictions match up with model predictions. [See this issue](https://github.com/tidymodels/tidypredict/issues/45) for more information.
